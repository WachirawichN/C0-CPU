...
#
# Generated by Vivado on Wed Jun 17 22:02:43 +07 2026
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/AluTestBench.sv"]"\
 "[file normalize "$origin_dir/AluOperationDecoderTestBench.sv"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/AluTestBench.sv"
set file [file normalize $file]
...
set file "$origin_dir/AluOperationDecoderTestBench.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
