...
#
# Generated by Vivado on Tue Jun 16 18:33:04 +07 2026
...
#
#    "/home/page/Work/C0-CPU/hardware/C0_vivado/C0_vivado.srcs/AluOperationDecoder/new/AluOperationDecoder_ooc.xdc"
#    "/home/page/Work/C0-CPU/hardware/C0_vivado/C0_vivado.srcs/utils_1/imports/synth_1/ALU.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/page/Work/C0-CPU/hardware/enums/AluOperation.sv"
#    "/home/page/Work/C0-CPU/hardware/srcs/ALU/AluOperationDecoder.sv"
#    "/home/page/Work/C0-CPU/hardware/srcs/ALU/ALU.sv"
#    "/home/page/Work/C0-CPU/hardware/tests/AluTestBench.sv"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/C0_vivado/C0_vivado.srcs/AluOperationDecoder/new/AluOperationDecoder_ooc.xdc"]"\
 "[file normalize "$origin_dir/C0_vivado/C0_vivado.srcs/utils_1/imports/synth_1/ALU.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/enums/AluOperation.sv"]"\
 "[file normalize "$origin_dir/srcs/ALU/AluOperationDecoder.sv"]"\
 "[file normalize "$origin_dir/srcs/ALU/ALU.sv"]"\
 "[file normalize "$origin_dir/tests/AluTestBench.sv"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/enums/AluOperation.sv"
...
set file "$origin_dir/srcs/ALU/AluOperationDecoder.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/srcs/ALU/ALU.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "new/AluOperationDecoder_ooc.xdc"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/tests/AluTestBench.sv"
set file [file normalize $file]
...
set_property -name "top" -value "AluTestBench" -objects $obj
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/ALU.dcp" -objects $obj
