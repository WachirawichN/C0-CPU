...
(
    ...
    output MEMRead      mem_read            = NO_MEM_READ,
    output MEMWrite     mem_write           = NO_MEM_WRITE,
    output rdSrc        rd_src              = RDSRC_ALU_RESULT,
    output rdWrite      rd_write            = NO_RD_WRITE
);
    logic funct7_bit;
    ...
    always_comb begin
        case (opcode)
            7'b0110011: begin
                ...
                alu_operand = 2'b00;
                alu_op      = ALUOp'({funct7_bit, funct3});
                com_op      = EQ;
                jmp_op      = NO_JUMP;
            ...
            7'b0010011: begin
                ...
                alu_operand = 2'b10;
                case (funct3)
                    3'b101: alu_op = ALUOp'({special_imm_bit, funct3});
                    default: alu_op = ALUOp'(4'(funct3));
                endcase
                com_op      = EQ;
                jmp_op      = NO_JUMP;
                mem_read    = NO_MEM_READ;
