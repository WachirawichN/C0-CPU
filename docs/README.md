...
But tl;dr, this architecture contains 33 total registers (not all of it is general purpose) and 40 instructions that can be use to program fully functions OS.
