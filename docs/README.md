...
The instruction inside the [Instruction Register](#instruction-register) is then decoded by [Instruction Decoder](#instruction-decoder) into multiple part, which is then processed further to generate their usable form.<br>
