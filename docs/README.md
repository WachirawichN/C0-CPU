...
2. `ALUOp`
    ...
    `1010` for `EQ` (equal) comparison operation.<br>
    `1011` for `NEQ` (not equal) comparison operation.<br>
    `1100` for `LT` (signed less than) comparison operation.<br>
    `1101` for `GE` (signed greater than) comparison operation.<br>
    `1110` for `LTU` (unsigned less than) comparison operation.<br>
    `1111` for `GEU` (unsigned greater than) comparison operation.<br>
3. `JmpOp`
